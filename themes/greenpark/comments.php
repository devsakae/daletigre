...
<br><br>
  ...
  <div class="Form">
    ...
    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
      <?php if ( $user_ID ) : ?>
      <p style="display: block; margin-top: 5px; font-size: 10px; font-weight: bold;">Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="<?php _e('Logout') ?>">Desconectar &raquo;</a> </p>
      <br clear="all" />
      <?php else : ?>
      <p>
      ...
      <p>
        ...
        <?php endif; ?>
        <textarea name="comment" id="comment" rows="6" tabindex="4" class="TextArea" style="width: 460px;" cols="7"></textarea>
        </label>
      </p>
      <p align="right">
